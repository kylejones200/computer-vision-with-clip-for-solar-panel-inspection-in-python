...
def main():
    ...
    model.fit(
        train_ds, validation_data=val_ds, epochs=2, callbacks=[early_stopping]
    )  # Set epochs as 2, should be more
    ...
    history = model.fit(
        train_ds, validation_data=val_ds, epochs=15, callbacks=[early_stopping]
    )
